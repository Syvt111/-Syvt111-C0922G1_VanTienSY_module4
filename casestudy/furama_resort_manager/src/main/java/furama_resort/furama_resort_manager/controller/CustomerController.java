...
import furama_resort.furama_resort_manager.DTO.CustomerDTO;
...
public class CustomerController {
    ...
    public String save(@Validated CustomerDTO customerDTO, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
