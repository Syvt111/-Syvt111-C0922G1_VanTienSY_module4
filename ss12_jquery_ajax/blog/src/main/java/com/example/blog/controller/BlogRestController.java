...
public class BlogRestController {
    ...
    @GetMapping("/blog")
    public ResponseEntity<List<BlogApp>> showList(@RequestParam(required = false, defaultValue = "") String content) {
        List<BlogApp> blogAppList = blogService.findByContentContaining(content);
